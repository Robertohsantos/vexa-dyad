...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a Vexa app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a Vexa app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.vexa.sh/api/connect-supabase/login",
      });
      logger.info(
