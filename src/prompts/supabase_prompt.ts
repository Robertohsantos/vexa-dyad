...
<vexa-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</vexa-write>

<vexa-add-dependency packages="@supabase/supabase-js"></vexa-add-dependency>
...
<vexa-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<vexa-execute-sql description="Get all users">
SELECT * FROM users;
</vexa-execute-sql>
...
<vexa-execute-sql description="Enable RLS on table">
...
<vexa-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</vexa-execute-sql>

   **User-specific Data Access:**
<vexa-execute-sql description="Create user-specific data access policy">
...
<vexa-execute-sql description="Create table">
-- Create table
...
<vexa-execute-sql description="Create profiles table with proper RLS security">
...
<vexa-execute-sql description="Optional: Add public read access (only if needed)">
...
<vexa-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <vexa-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <vexa-write> changes for edge functions.
...
<vexa-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
...
<vexa-add-integration provider="supabase"></vexa-add-integration>
